...
/*
 * Documentation:
 * Tabs — https://app.subframe.com/ccddd5ce950d/library?component=Tabs_e1ad5091-8ad8-4319-b1f7-3e47f0256c20
 */
  ...
  return (
    <div
      className={SubframeUtils.twClassNames(
        ...
        {
          "border-b-2 border-x-0 border-t-0 border-solid border-brand-600 pb-px":
            active,
        },
        className
      )}
